-- First, update the exams table to use jsonb for content
...
-- Ensure exams table has proper foreign key to classes
...
-- Update RLS policies for exams to handle the new structure
